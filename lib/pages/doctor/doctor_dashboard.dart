...
class _DoctorDashboardState extends State<DoctorDashboard> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          drawer: DrawerMenu(DashboardCardData.drawerDoctorList),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: GridView.count(
                    ...
                    children: List.generate(DashboardCardData.doctorList.length, (index) {
                      return InkWell(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => DashboardCardData.doctorList[index].screen));
                        },
                        child: Padding(
                            padding: EdgeInsets.symmetric(vertical: 10.h,horizontal: 10.w),
                            child:  TopCard(icon: DashboardCardData.doctorList[index].icon, title:  DashboardCardData.doctorList[index].title)),
                      );
