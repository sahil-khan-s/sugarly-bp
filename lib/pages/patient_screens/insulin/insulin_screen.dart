import 'package:bpcheck/pages/patient_screens/insulin/insulin_record.dart';
...
class InsulinScreen extends StatefulWidget {
  const InsulinScreen({Key? key}) : super(key: key);
...
class _InsulinScreenState extends State<InsulinScreen> {
  ...
  CustomTextField tfInsulin = CustomTextField();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(AppStrings.insulin,style: TextStyle(color: AppColors.bgBoarding,fontSize: 12.sp)),

              SizedBox(height: 10.h,),
              tfInsulin.setHint(AppStrings.insulin).setSuffixIcon(Icons.add),
  ...
  void saveInsulinData() {
    ...
    InsulinRecord insulinRecord=InsulinRecord(insulin: tfInsulin.tfController.text,dosage: tfDosage.tfController.text,
    notes: tfNotes.tfController.text,unit: unit
    );

    Provider.of<DatabaseService>(context,listen: false).addRecord('insulin', insulinRecord.toJson());
    tfInsulin.tfController.text="";
